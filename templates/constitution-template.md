# [DEPARTMENT_NAME] Operations Constitution
<!-- [COMPANY_NAME] OKR Planning Governance Framework -->
...
- The `organization-context.md` file provides **environmental context** (how to apply rules effectively)
