...
**Note**: This checklist is generated by the `checklist` prompt based on initiative context and business requirements.

<!-- 
  ============================================================================
  IMPORTANT: The checklist items below are SAMPLE ITEMS for illustration only.
  
  The `checklist` prompt MUST replace these with actual items based on:
...
- **Recommended**: Complete OKR Quality and Initiative Readiness checklists before running the `plan` prompt
- **Recommended**: Complete Stakeholder and Resource checklists before running the `implement` prompt
